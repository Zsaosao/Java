...
public class Test {
    ...
    public static void main(String[] args) throws CannotCreateCard {
        ...
        File f = new File("src\\hhh\\output");
        if (!f.exists()) {
            f.mkdirs();
        }

        // Create TransactionProcessing object to test Requirement 3, 4, 5
        TransactionProcessing tp = new TransactionProcessing("src\\hhh\\data\\IDCard.txt",
                "src\\hhh\\data\\PaymentInformation.txt");
        int option = 1;
        if (args.length == 1) {
        ...
        switch (option) {
            case 1:
                ...
                writeFile("src\\hhh\\output\\Req3.txt", req3);
                break;
            // case 2:
            ...
            // break;
            // case 4:
            // TransactionProcessing tp1 = new TransactionProcessing("data\\IDCard.txt",
            // "data\\PaymentInformation.txt");
            // tp1.processTopUp("data\\TopUpHistory.txt");
            // ArrayList<Payment> req6 = tp1.getPaymentObject();
            // writeFile("output\\Req6.txt", req6);
            // break;
            // case 5:
            // TransactionProcessing tp2 = new TransactionProcessing("data\\IDCard.txt",
            // "data\\PaymentInformation.txt");
            ...
            // break;
            // case 6:
            // TransactionProcessing tp3 = new TransactionProcessing("data\\IDCard.txt",
            // "data\\PaymentInformation.txt");
            ...
            // break;
            // case 7:
            // TransactionProcessing tp4 = new TransactionProcessing("data\\IDCard.txt",
            // "data\\PaymentInformation.txt");
