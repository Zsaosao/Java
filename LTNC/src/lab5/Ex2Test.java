...
public class Ex2Test {
	public static void main(String[] args) {
		...
		System.out.println("Check triangle Matrix true case: " + Ex2.isTriangleMatrix(array2DOne));
		int[][] array2DTwo = { { 1, 2, 3, 4 }, { 0, 4, 5, 6 }, { 0, 0, -5, -7 }, { 0, 0, 0, 0 } };
		System.out.println("Check triangle Matrix true case: " + Ex2.isTriangleMatrix(array2DTwo));
		int[][] array2DThree = { { 1, 2, 3, 4 }, { 0, 0, 5, 6 }, { -60, 50, 0, -7 }, { 0, 0, 0, 0 } };
		System.out.println("Check triangle Matrix false case: " + Ex2.isTriangleMatrix(array2DThree));

		int[][] array2DFour = { { 1, 2, 3 }, { 2, 4, 5 }, { 3, 5, 6 } };
		System.out.println("Check Symmetric Matrix Through Main Diagonal true case: "
				+ Ex2.isSymmetricMatrixThroughMainDiagonal(array2DFour));
